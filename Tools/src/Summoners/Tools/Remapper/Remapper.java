...
public class Remapper {
    ...
    public Object mapValue(Object value) {
        if (value instanceof Type) {
            ...
            return new Handle(this.mapMethodAccess(handle.getOwner(), handle.getName(), handle.getDesc(), handle.getTag()), this.mapType(handle.getOwner()), this.mapMethodName(handle.getOwner(), handle.getName(), handle.getDesc(), handle.getTag()), handle.getTag() <= 4 ? this.mapDesc(handle.getDesc()) : this.mapMethodDesc(handle.getDesc()), handle.isInterface());
    ...
    public String mapInnerClassName(String name, String ownerName, String innerName, int access) {
    ...
    public int mapInnerClassAccess(String name, String ownerName, String innerName, int access) {
        return access;
    }

    public String mapMethodName(String owner, String name, String descriptor, int access) {
        return name;
    }
    ...
    public String mapFieldName(String owner, String name, String descriptor, int access) {
        return name;
    }
    public int mapFieldAccess(String owner, String name, String descriptor, int access) {
        return access;
    }
    ...
    public int mapAccess(String intenralName, int access) {
        return access;
    }
}
